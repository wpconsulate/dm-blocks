...
class dm_block_WP_Post_Meta_Revisioning {
...
$wp_Post_Meta_Revisioning = new dm_block_WP_Post_Meta_Revisioning;

function dm_block_add_meta_keys_to_revision( $keys ) {
	$keys[] = 'dm_block_html';
	$keys[] = 'dm_block_css';
	$keys[] = 'dm_block_js';
	return $keys;
}
add_filter( 'wp_post_revision_meta_keys', 'dm_block_add_meta_keys_to_revision', 10, 2 );